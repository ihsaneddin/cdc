        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="footer-widget">
                    ...
                    <div class="media">
                        <a class="pull-left" href="#"><img class="media-object" src="<?php image_url('demo/m2.jpg')?>" width="75" height="75" alt="image"></a>
                    ...
                    <div class="media">
                        <a class="pull-left" href="#"><img class="media-object" src="<?php image_url('demo/m11.jpg')?>" width="75" height="75" alt="image"></a>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <a class="pull-left" href="#"><img class="media-object" src="<?php image_url('demo/m4.jpg')?>" width="75" height="75" alt="image"></a>
                        <div class="media-body">
                ...
                <div class="footer-widget">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                            <a href="#" class="thumbnail"><img src="<?php image_url('demo/wf1.jpg')?>" class="img-responsive" alt="Image"></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                            <a href="#" class="thumbnail"><img src="<?php image_url('demo/wf2.jpg')?>" class="img-responsive" alt="Image"></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                            <a href="#" class="thumbnail"><img src="<?php image_url('demo/wf3.jpg')?>" class="img-responsive" alt="Image"></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                            <a href="#" class="thumbnail"><img src="<?php image_url('demo/wf4.jpg')?>" class="img-responsive" alt="Image"></a>
                        </div>
                    </div>
                </div>
            </div>
